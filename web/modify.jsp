		...
		<li><a class="for_a_global" href="wear?type=query&pageIndex=1&userid=${userid}">穿搭</a></li>
			...
			<div class="container">
				...
				<h4 class="text-center" style="color:#f86a83;"><strong>详情</strong></h4><br/>
					<form action="wardrobe?type=modify&userid=${userid}" role="form" method="post" enctype="multipart/form-data">
				    	<div class="form-group">
		  				...
		  				<div class="form-group">
		          	      	...
		          	      	<input type="text" class="form-control" name="name_m" value="${clothes.name}" placeholder="请输入名称">
		  				</div>
		  				
			   	    	<div class="form-group">
		          	      	<label>价格</label>
		          	      	<input type="text" class="form-control" name="price" value="${clothes.price}" placeholder="请输入价格">
		  				</div>
		  				<div class="form-group">
		          	    	<label>类型</label><br/>
					...
					<c:if test="${(!'格裙'.equals(clothes.type))&&(!'水手服'.equals(clothes.type))}">
						...
						<td rowspan="9" valign="top" >
							<fieldset style="width: 210px; height: 370px;">
								<legend>图片预览</legend>
								<img id="imgPic" src="${clothes.pic}" style="float:left; width:100%; height:100%;"/>
							</fieldset>
						</td>
