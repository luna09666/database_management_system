...
<div class="container">
	...
	<form action="wardrobe?type=add&userid=${userid}" role="form" method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
			<label>名称</label>
			<input type="text" class="form-control" name="name_a" value="${grass.name}" placeholder="请输入名称">
		</div>
		<div class="form-group">
			<label>价格</label>
			<input type="text" class="form-control" name="buyprice" value="${grass.price}" placeholder="请输入价格">
		</div>
		<div class="form-group">
			<label>类型</label><br/>
		...
		<div>
			<input type="submit" value="购买" class="button_for_text" onclick="return confirm('确认购买');">
		</div>
